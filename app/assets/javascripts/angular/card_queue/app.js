(function() {
  ...
  var app = angular.module('card-queue', ['manage-recipients', 'queue-wizard', 'ngAnimate', 'ngMessages', 'ui.router', 'ui.bootstrap.alert', 'templates', 'vr.directives.nlForm', 'angularSpinner', 'fancyboxplus', 'angular-click-outside', 'calendarApp', 'CaseFilter', 'credit-cards', 'angular-stripe']);
